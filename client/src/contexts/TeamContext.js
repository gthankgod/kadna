...
const TeamContextProvider = (props) => {
    const [team, setTeam] = useState(
        [
            ...
            {
                id: 5, name: 'HON TAIWO OLORUNDARE', title: 'NON-EXECUTIVE', imgUrl: 'https://res.cloudinary.com/dnmaekeqy/image/upload/v1583009773/humanicon_kcpoqo.jpg', profile: `Hon. Taiwo holds a BSc in Geography and Regional Planning, MSc Urban Traffic and Transportation planning. He has worked in various organizations in Nigeria and also serve in different bodies. He his a member of various professional bodies and later was appointed as the senior special adviser to the deputy governor of Ekiti state on special duty in 2017.
            ...
            {
                id: 7, name: 'MR YAHAYA ISHAQ HUSSAIN', title: 'ED MARKETING AND SALES', imgUrl: 'https://res.cloudinary.com/dnmaekeqy/image/upload/v1583009773/humanicon_kcpoqo.jpg', profile: `He holds a B.Sc. Degree from Bayero University, Kano. He
            ...
            {
                id: 10, name: 'Mr Benedict Olusola AMUSAN', title: 'DGED Human Resources / Admin', imgUrl: 'https://res.cloudinary.com/dnmaekeqy/image/upload/v1581762329/vc_rijpxq.jpg', profile: `Mr Benedict is an human resources professional with 10 years’ experience in different HR functions including Recruitment, Business Partnering, Performance Management, Expatriate Management, Talent Management, Learning Management, Organizational Development and Employee Services.
                He has worked with several multinational company and also a senior admin manager in MTN and also a strong NGO R2L until he was appointed in 2020 by kadna board has the DGED Human resources and Admin.`, show: false
            }
        ]
    );
