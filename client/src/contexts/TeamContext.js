...
const TeamContextProvider = (props) => {
    const [team, setTeam] = useState(
        [
            ...
            {
                id: 5, name: 'MR Olamide .O.Fasipe', title: 'ED LOGISTICS AND SUPPLY CHAIN MANAGEMENT', imgUrl: 'https://res.cloudinary.com/dnmaekeqy/image/upload/v1579353385/PHOTO-2019-12-22-08-23-56_1_netkrn.jpg', profile: `Olamide is currently the Executive Director, Logistics and Supply Chain Management. Prior to his appointment
            ...
            {
                id: 6, name: 'MR YAHAYA ISHAQ HUSSAIN', title: 'ED MARKETING AND SALES', imgUrl: 'https://d19m59y37dris4.cloudfront.net/university/1-1-1/img/teacher-4.jpg', profile: `He holds a B.Sc. Degree from Bayero University, Kano. He
